(function () {
    ...
    function translations(ar) { return ar ? {
        ...
        prompts: ['إيه هو استافو؟', 'ازاي الاقي انسب مشاريع ووحدات لعملائي؟', 'ازاي اعمل موقع عقاري ذكي باسمي؟'],
        ...
        prompts: ['What is Estavo?', 'How can I find the best projects and units for my clients?', 'How can I create a smart real estate website under my own name?'],
